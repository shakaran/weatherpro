...
<script type="text/javascript">
          ...
          load: function(event, ui) {
              ...
              // Code source http://sonspring.com/journal/jquery-iframe-sizing
                  ...
                  $(tiframe).unload(function(){
                    $("#WU-Gd-Tabs .ui-tabs-panel:not(ui-tabs-hide) .gload").fadeIn(300); // for loader
                  });
        				}
        			);        		
              ...
              if ("'.$dataSource.'" == "wutowdmysql") {
                $(".WUGiframe").load(function(){
                  ...
                  selectedWugDate.setFullYear($.cookie("wu_graph_y"),$.cookie("wu_graph_m"),$.cookie("wu_graph_d"));
                  startWDdb = new Date();
                  startWDdb.setFullYear('.$wdSinceY.','.$wdSinceM.','.$wdSinceD.');
  ...
  <div id="WU-Gd-Tabs" class="WUG-subtab">
  	 <ul style="/*height:25px;*/">
  		<li><a href="./wxwugraphs/iframe-inc.php?pg=graphd1"><span>'.$TempTran.'</span></a></li>
  		<li><a href="./wxwugraphs/iframe-inc.php?pg=graphd3"><span>'.$HumTran.'</span></a></li>  		  		
  		<li><a href="./wxwugraphs/iframe-inc.php?pg=graphd5"><span>'.$BaroTran.'</span></a></li> 
      <li><a href="./wxwugraphs/iframe-inc.php?pg=graphd4"><span>'.$WSTran.'</span></a></li>
      <li><a href="./wxwugraphs/iframe-inc.php?pg=graphd2"><span>'.$windDirTran.'</span></a></li>
      <li><a href="./wxwugraphs/iframe-inc.php?pg=graphd7"><span>'.$PrecTran.'</span></a></li>
';
if ($showSolar) {
  echo '      <li><a href="./wxwugraphs/iframe-inc.php?pg=graphd6"><span>'.$SunTran.'</span></a></li>'."\n";
} 
echo '	  </ul>
	</div>
';
