...
#---------------------------------------------------------------------------
# '3.20 2015-09-06 beta rel 2.8 version
#---------------------------------------------------------------------------
...
function ws_date_format() {
        ...
        if     (!isset ($my_date_format) )        {
                $SITE['tags_ymd']       = array (3,2,1); $SITE['tags_ymd_sep']   = '/'; 
                $SITE['my_date_format'] = 'dd-mm-yyyy';
                return false;
        }
        else   {$SITE['my_date_format'] = $my_date_format;}
#
