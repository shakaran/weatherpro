...
<?php } ?>	
	...
	<table style=""> <!-- today yesterday min max values -->
	<tbody>
	<tr><th>  </th><th><?php echo langtransstr('Today'); ?></th><th><?php echo langtransstr('Yesterday'); ?></th></tr>
	<tr><td style="font-weight: bold;"><br /><?php echo langtransstr('High:'); ?></td>
		<td><span class="ajax" id="ajaxtempmax"><?php echo $vars['ajaxtempmax'];?></span>
		<br />(<span class="ajax" id="ajaxtempmaxTime"><?php echo  $vars['ajaxtempmaxTime'];?></span>)</td>
		<td><?php echo wsNumber($ws['tempMaxYday']).$uomTemp;?><br /><?php echo  "(".string_date($ws['tempMaxYdayTime'],$SITE['timeOnlyFormat']).")";?></td>
	</tr><tr><td></td><td></td><td></td></tr>
	<tr><td style="font-weight: bold;"><br /><?php echo langtransstr('Low:'); ?></td>
		<td><span class="ajax" id="ajaxtempmin"><?php echo $vars['ajaxtempmin'];?></span>
		<br />(<span class="ajax" id="ajaxtempminTime"><?php echo $vars['ajaxtempminTime'];?></span>)</td>
		<td><?php echo wsNumber($ws['tempMinYday']).$uomTemp;?><br /><?php echo "(".string_date($ws['tempMinYdayTime'],$SITE['timeOnlyFormat']).")";?></td>
	</tr>
	</tbody>
	</table> <!-- today yesterday min max values -->
	</div> <!-- col-temp -->	
	<div class="colRight">	
...
if (!$SITE['SOLAR']) { 
	...
	'&nbsp;<a href="'.$SITE['pages']['printUV'].'&amp;lang='.$lang.$extraP.$skiptopText.'"><img src="./img/i_symbolWhite.png" style="margin:1px; vertical-align: middle;" alt="more information" title="more information"></a>'.'</h3>'.PHP_EOL;
        $skipUVhtml     = true;
