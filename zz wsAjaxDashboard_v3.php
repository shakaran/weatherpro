...
$pageVersion	= '3.20 2015-8-06';
#-------------------------------------------------------------------------------
# 3.20 2015-08-06 release 2.8 version plus check for moonrise-set == ''
#-------------------------------------------------------------------------------
...
if (!$SITE['SOLAR']) { 
	...
	'&nbsp;<a href="'.$SITE['pages']['printUV'].'&amp;lang='.$lang.$extraP.$skiptopText.'"><img src="./img/submit.png" style="margin:1px; vertical-align: middle;" alt="more information" title="more information"></a>'.'</h3>'.PHP_EOL;
        $skipUVhtml     = true;
...
<?php
# ----------------------  version history
# 3.20 2015-08-06 release 2.8 version 
