<?php
############################################################################
# European Weather Network WRF-Forecast v. 3.6 (Mar 2015)
############################################################################
#
...
$nfrcbody = '
    ...
    <span class="moremaps" id="dwd">DWD ICON - '.$data[dwd][dwdreso].' km</span>
  ...
  background-image: -o-linear-gradient(top, rgba(92,172,238,0), rgba(92,172,238,0.75), rgba(92,172,238,0));"></td>
    ...
    <td class="mapPropsTd">
    <input type="radio" class="checkboxes" name="radio" id="dwd_temp" data-txt1="2m '.FTEMP.'"/>
    <label for="dwd_temp">'.FTEMP.'</label><br/>
    <input type="radio" class="checkboxes" name="radio" id="dwd_chill" data-txt1="'.FCHILL.'"/>
    <label for="dwd_chill">'.FCHILL.'</label><br/>
    <input type="radio" class="checkboxes" name="radio" id="dwd_wind" data-txt1="'.FWIND.'"/>
    <label for="dwd_wind">'.FWIND.'</label><br/>
    <input type="radio" class="checkboxes" name="radio" id="dwd_gust" data-txt1="'.FGUST.'"/>
    <label for="dwd_gust">'.FGUST.'</label><br/>
    <input type="radio" class="checkboxes" name="radio" id="dwd_psnow" data-txt1="'.FPREC.' + '.FCLOUD.'"/>
    <label for="dwd_psnow">'.FPREC.' + '.FCLOUD.'</label><br/>
    <input type="radio" class="checkboxes" name="radio" id="dwd_precip" data-txt1="'.FPREC.'"/>
    <label for="dwd_precip">'.FPREC.'</label><br/>
    <input type="radio" class="checkboxes" name="radio" id="dwd_baro" data-txt1="'.FBARO.'"/>
    <label for="dwd_baro">'.FBARO.'</label><br/>
    </td>
    </tr></table>
  ...
  <tr>
	...
	<tr>
	<td class="finfocontenttd"><b>DWD ICON</b></td>
	<td class="finfocontenttd">'.$data[dwd][dwdupd].'</td>
	<td class="finfocontenttd">'.$data[dwd][dwdreso].' km</td>
	<td class="finfocontenttd">'.$data[dwd][dwdlength].'h</td>
	<td class="finfocontenttd col450">'.$data[dwd][dwdsteps].'h</td>
	</tr>
	<tr>
...
<table class="letable wrf_psnow dwd_psnow">
<tr><td class="letda" style="background-color:rgb(136,0,102)"></td><td class="letdb">30+ mm</td></tr>
<tr><td class="letda" style="background-color:rgb(131,0,136)"></td><td class="letdb">25-30 mm</td></tr>
<tr><td class="letda" style="background-color:rgb(92,1,135)"></td><td class="letdb">20-25 mm</td></tr>
<tr><td class="letda" style="background-color:rgb(0,0,153)"></td><td class="letdb">15-20 mm</td></tr>
...
<table class="letable wrf_precip fmi_precip dwd_precip" style="width:85px;float:right">
...
<table class="letable wrf_temp wrf_dew wrf_chill wrf_tmpsfc fmi_temp fmi_chill fmi_dew gfs_temp gfs_chill gfs_dew gfs_t850 wrf_t850 dwd_temp dwd_chill" style="width:60px;float:right">
...
<table class="letable wrf_wind wrf_gust fmi_wind fmi_gust gfs_wind dwd_wind dwd_gust" style="width:85px;float:right">
