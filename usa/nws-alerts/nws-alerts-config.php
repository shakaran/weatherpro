...
$myZC = array(
 /*       "Test|ILC045",  
  ...
  "Jackson, IA|IAZ054|IAC097", */
"Cedar, IA|IAZ065|IAC031",
"Clinton, IA|IAZ066|IAC045",
/*
 "Montgomery County|NYZ040|NYC057",
  "Southern Fulton County|NYZ039|NYC035",
  "Otsego County|NYZ046|NYC077",
  "Schoharie County|NYZ047|NYC095",
  "Southern Herkimer County|NYZ038|NYC043",
  "Western Schenectady County|NYZ048|NYC093",
  "Southern Saratoga County|NYZ050|NYC091",
  "Northern Fulton County|NYZ082|NYC035",
  "Northern Herkimer County|NYZ032|NYC043",
  "Eastern Schenectady County|NYZ049|NYC093",
  "Hamilton County|NYZ033|NYC041",
  "Northern Saratoga County|NYZ041|NYC091",
*/
); 

if (!is_array ($SITE) ) {$SITE = array(); include_once '../wsLoadSettings.php';}
// MAIN SETTINGS
// folders
$curlyfolder	= 'usa/nws-alerts/';
$cacheFileDir	= $SITE['cacheDir']; 			// default cache file directory
$icons_folder	= $curlyfolder.'alert-images'; 	// folder that contains the icons. No slash on end
// file names
...
$alertURL	= $SITE['pages']['wsnws-details'].$extraP;
$summaryURL	= $SITE['pages']['wsnws-details'].$extraP;
// GENERAL SETTINGS
$ourTZ         = $SITE['tz'] ;        			// Time Zone     http://www.php.net/manual/en/timezones.america.php
...
$log_folder    = $curlyfolder.'alertlog';		// folder that contains the log files. No slash on end

// ALERT BOX SETTINGS
$useAlertBox   = true; 							// true=use alert box & write data file   false= not using alert box & don't write file
$titleNewline  = false; 						// true=new line for each title   false=string titles with other titles
$aBox_Width    = '100%';						// width of box  examples - $aBox_Width = '80%';  $aBox_Width = '850px';  or smallest box  $aBox_Width = '';
$centerText    = true;							// true=center text in alert box    false=left align text
$showNone      = $SITE['warningGreen'];			// true=show 'NONE' if no alerts in alert box   false=don't show alert box if no alerts
...
$shoNone       = $SITE['warningGreen'];;    // true=show one 'NONE' if no alerts for all location   false=don't show one 'NONE' if no alerts for all location
...
$rssTitle = 'Michiana Area Weather Alerts';  #####    // title for the RSS/XML page 
